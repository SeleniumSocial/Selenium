...
public class AdvannualtoPromonthly 
{
	WebDriver driver;
	 ...
	 @Test
	 public void advannualtoPromonthly() throws Exception
	 {
		//Read Property file
		...
		//Give credit card number
		 ...
		 System.out.println("Now Advance annual user is converted to Pro monthly user");
	 }
	 @AfterClass
