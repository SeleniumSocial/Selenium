...
public class AdvannualtoProyearly
{
	WebDriver driver;
	 ...
	 @Test
	 public void advannualtoProyearly() throws Exception
	 {
		//Read Property file
		...
		//Give credit card number
		 ...
		 System.out.println("Now Advance annual user is converted to Pro Annual user ");
	 }
	 @AfterClass
