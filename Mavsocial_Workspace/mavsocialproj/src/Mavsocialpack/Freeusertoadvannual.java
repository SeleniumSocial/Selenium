...
public class Freeusertoadvannual 
{
	 WebDriver driver;
	...
	@Test
	public void freeusertoadvannual() throws Exception
	{
		Thread.sleep(4000);
		...
		//Validate current plan -Advanced(annual).
		 ...
		 System.out.println("The User is successfully converted his plan from Free user to advanced annual user ");
	}
}
