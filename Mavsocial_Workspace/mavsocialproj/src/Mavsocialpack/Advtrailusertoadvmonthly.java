...
public class Advtrailusertoadvmonthly 
{
   		WebDriver driver;
		...
		public void openbrowser() throws Exception 
		 ...
		 @Test
		 public void advtrailusertoadvmonthly() throws InterruptedException
		 {
			...
			softassert.assertEquals(currentplan2.getText(), "Current Plan - Advanced (monthly)");
