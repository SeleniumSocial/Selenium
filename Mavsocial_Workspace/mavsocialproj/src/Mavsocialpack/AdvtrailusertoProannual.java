...
public class AdvtrailusertoProannual 
{
	WebDriver driver;
	...
	public void openbrowser() throws Exception 
	 ...
	 @Test
	 public void advtrailusertoProanual() throws Exception
	 {
		...
		//Scroll window 
			...
			//Give credit card number
			 ...
			 System.out.println("Now Advanced trail user is converted to Pro annual user");
}
}
