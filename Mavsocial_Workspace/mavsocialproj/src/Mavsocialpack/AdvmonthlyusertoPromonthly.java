...
public class AdvmonthlyusertoPromonthly 
{
	 WebDriver driver;
	 ...
	 @Test
	 public void advmonthlytoPromonthly() throws Exception
	 {
		...
		//Give credit card number
		 ...
		 System.out.println("Now Advanced monthly user is converted to Pro monthly user");	 
