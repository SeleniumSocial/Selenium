...
public class AdvusertoProuser 
{
	 ...
	 public void advusertoprousrmonthly() throws Exception 
	 {
		//Read Property file
		 ...
		 Assert.assertEquals(currentplan.getText(),"Current Plan - Advanced (yearly)");
		 System.out.println("User current plan is  - Advanced (yearly)");
		 
		 //Check Cancel Advanced Subscription label is displayed or not 
		 Assert.assertEquals(driver.findElement(By.xpath(obj.getProperty("cancleadvsub"))).getText(),"Cancel Advanced Subscription");
		 ...
		 Assert.assertEquals(uptopro.getText(),"Upgrade to PRO");
		 Thread.sleep(4000);
		 uptopro.click();
		 //Verify Pro plan subscription label is displayed or not
		 Assert.assertEquals(driver.findElement(By.className(obj.getProperty("proplansub"))).getText(),"PRO PLAN SUBSCRIPTION");
		 ...
		 Assert.assertEquals(togglemonthly.getText(),"MONTHLY");
		 ...
		 Assert.assertEquals(monthlyamt.getText(),"$78");
		...
		//check toggle button is  Annual or not
		 ...
		 Assert.assertEquals(toggleannual.getText(),"ANNUAL");
		 ...
		 Assert.assertEquals(annualamt.getText(),"$936");
		...
		//Give credit card number
		 ...
		 Assert.assertEquals(cong.getText(),"Congratulations !");
	 ...
	 {	 
		//Read Property file
		 ...
		 WebElement currentplan=driver.findElement(By.xpath(obj.getProperty("currentplan")));
		 System.out.println(currentplan.getText());
		 Assert.assertEquals(currentplan.getText(),"Current Plan - PRO (monthly)");
		 System.out.println("User current plan is  - pro (monthly)");
		 //Verify cancel Pro subscription is displayed or not 
		 Assert.assertEquals(driver.findElement(By.xpath(obj.getProperty("cancleadvsub"))).getText(),"Cancel PRO Subscription");
		 System.out.println("Cancel PRO Subscription label displayed successfully!");
		 //Verify Upgrade to pro button is displayed or not
		 WebElement uptopro=driver.findElement(By.xpath(obj.getProperty("upgradetopro")));
		 Assert.assertEquals(uptopro.getText(),"Upgrade to Annual");
		 Thread.sleep(4000);
		 uptopro.click();
		 //Verify Pro plan subscription label is displayed or not
		 Assert.assertEquals(driver.findElement(By.className(obj.getProperty("proplansub"))).getText(),"PRO PLAN SUBSCRIPTION");
		...
		//Check the user current plan is Pro monthly or not?
		 ...
		 Assert.assertEquals(currentplan2.getText(),"Current Plan - PRO (yearly)");
