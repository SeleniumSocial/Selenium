package com.mavSocial.testBase;
...
import com.mavSocial.customListner.Listner;
import com.mavSocial.excelReader.ExcelReader;
...
static
{
	Calendar calendar=Calendar.getInstance();
  	...
  	extent=new ExtentReports(System.getProperty("user.dir")+"//src//main//java//com//mavSocial//reports//Test_Execution_Report-"+formater.format(calendar.getTime())+".html",false);
...
public void load_data() throws IOException {
	File config = new File(System.getProperty("user.dir") + "//src//main//java//com//mavSocial//config//config.properties");
	//File homepage= new File(System.getProperty("user.dir") + "//src//main//java//com//mavSocial//config//homepage.properties");
...
public String capture_screen(String fileName) 
{
	...
	try {
		String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "//src//main//java//com//mavSocial//screenShots//Screen_Shot_Of-";
...
public String[][] getData(String excelName, String sheetName) throws BiffException, IOException
{
	...
	String excellocation = System.getProperty("user.dir")+"//src//main//java//com//mavSocial//data//"+excelName;
